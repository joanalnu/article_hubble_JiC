...
#M_W_error_down = list()
#for i in range(len(p_data)):
    #M_W = -3.423*(math.log10(p_data[i])-1.4)-7.202
    #M_W_data.append(M_W)
    #M_W_error_up.append(abs(M_W_up-M_W))
    #M_W_up = -3.381*(math.log10(p_data[i])-1.4)-7.182
    #M_W_down = -3.465*(math.log10(p_data[i])-1.4)-7.222
    #M_W_error_down.append(abs(M_W_down-M_W))
...
#ax[2,0].scatter(aux_id_data, M_W_data, color='green')
#ax[2,0].set_xlabel('Cepheid ID')
#ax[2,0].set_ylabel('absolute Magnitude M_W')
#ax[2,0].errorbar(aux_id_data, M_W_data, yerr=[M_W_error_down, M_W_error_up], fmt='none', color='red', capsize=5, label='Error Bars')
...
#ax[2,1].scatter(p_data, M_W_data, color='green')
#ax[2,1].set_xlabel('Period [days]')
#ax[2,1].set_ylabel('absolute Magnitude M_W')
#ax[2,1].errorbar(p_data, M_W_data, yerr=[M_W_error_down, M_W_error_up], fmt='none', color='red', capsize=5, label='Error Bars')
